...
import { saveInvoiceBranding, sanitizeHexColor } from "@/lib/invoice/branding";
...
// readInvoiceSettings() DIHAPUS (2026-08-17): nol pemanggil di seluruh repo,
// dan komentarnya menyebut pemakaian yang sudah tidak ada lagi.
//
// Bukan sekadar merapikan kode mati: fungsi ini diekspor dari berkas Server
// Action, dan Server Action yang diekspor adalah ENDPOINT HTTP yang hidup -
// bisa dipanggil siapa pun, sementara ini satu-satunya di berkas ini yang tidak
// bergerbang. Kode mati yang tidak bisa dipanggil dari UI tetap bisa dipanggil
// dari luar. Kalau ringkasan pengaturan dibutuhkan lagi, panggil
// getInvoiceBranding()/getManualOrderSettings() langsung dari Server Component -
// keduanya bukan Server Action dan tidak membuka endpoint apa pun.
